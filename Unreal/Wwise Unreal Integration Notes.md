...
2. I've verified this works for a blueprint-focused project in **Unreal 5.6.1** with **Wwise 2024.1.8.8898**, and also **Unreal 5.4.3**, using **Wwise 2023.1.4** (folders are slightly different; see the second table).
...
## List of Files/Folders to Delete (Wwise 2024):
...
|Plugins/WwiseSoundEngine/Binaries/Mac								|Only delete if you have no plan to work on/build for macs|
|Plugins/WwiseSoundEngine/Binaries/Win64/*.pdb						|.pdb files are debugging symbols; unless you're planning on debugging Wwise itself I don't think you need these|
|Plugins/WwiseSoundEngine/ThirdParty/x64_vc160						|Standard 64-bit Windows libraries, but for the older vc160 runtime. If your copy of Visual Studio is up to date you'll be running vc170, and don't need this|
|Plugins/WwiseSoundEngine/ThirdParty/x64_vc170/Debug(StaticCRT)		|Contains an executable called `IntegrationDemo`; seems unnecessary|
|Plugins/WwiseSoundEngine/ThirdParty/x64_vc170/Profile(StaticCRT)	|Contains an executable called `IntegrationDemo`; seems unnecessary|
|Plugins/WwiseSoundEngine/ThirdParty/x64_vc170/Release(StaticCRT)	|Contains an executable called `IntegrationDemo`; seems unnecessary|
|Plugins/Wwise/WwiseSoundEngine/x64_vc170/Debug/lib					|You'll need this if you plan on building a Debug build of your game, but otherwise it's not necessary|
|Plugins/Wwise/WwiseSoundEngine/x64_vc170/Profile/lib				|You'll need this if you plan on building a Profile build of your game, but otherwise it's not necessary|
|Plugins/Wwise/WwiseSoundEngine/x64_vc170/Debug/bin/\*.pdb			|.pdb files are debugging symbols; unless you're planning on debugging Wwise itself I don't think you need these|
|Plugins/Wwise/WwiseSoundEngine/x64_vc170/Profile/bin/\*.pdb		|.pdb files are debugging symbols; unless you're planning on debugging Wwise itself I don't think you need these|
|Plugins/Wwise/WwiseSoundEngine/x64_vc170/Release/bin/\*.pdb		|.pdb files are debugging symbols; unless you're planning on debugging Wwise itself I don't think you need these|

## List of Files/Folders to Delete (Wwise 2023):
(all paths are relative to your Unreal project's base directory)
